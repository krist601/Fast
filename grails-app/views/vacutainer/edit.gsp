...
<html>
	...
	<body>
		<a href="#edit-vacutainer" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-vacutainer" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${vacutainerInstance?.version}" />
				<fieldset class="form">
