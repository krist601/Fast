...
<html>
	...
	<body>
		<a href="#edit-inventory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-inventory" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${inventoryInstance?.version}" />
				<fieldset class="form">
