...
<html>
    ...
    <body>
        <ul class="breadcrumbs">
            ...
            <li>Mostrar Control de Medidas</li>
        </ul>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <div class="widget">
                    <h4 class="widgettitle" style="font-size: 30px;">Control de Medidas: ${measuresControlInstance?.id}</h4>
                        ...
                        <div id="show-measuresControl" class="content scaffold-show" role="main">
                            ...
                            <g:form>
                                <fieldset class="buttons">
                                    ...
                                    <g:link class="btn btn-primary" action="edit" id="${measuresControlInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
