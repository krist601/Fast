...
<html>
	...
	<body>
		<a href="#edit-measuresControl" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-measuresControl" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${measuresControlInstance?.version}" />
				<fieldset class="form">
