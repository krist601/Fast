...
<html>
	...
	<body>
		<a href="#edit-treatment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-treatment" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${treatmentInstance?.version}" />
				<fieldset class="form">
