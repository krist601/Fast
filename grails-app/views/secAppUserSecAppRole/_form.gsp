...
<div class="fieldcontain ${hasErrors(bean: secAppUserSecAppRoleInstance, field: 'secAppRole', 'error')} required">
	...
	<g:select id="secAppRole" name="secAppRole.id" from="${user.SecAppRole.list()}" optionKey="id" required="" value="${secAppUserSecAppRoleInstance?.secAppRole?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: secAppUserSecAppRoleInstance, field: 'secAppUser', 'error')} required">
	...
	<g:select id="secAppUser" name="secAppUser.id" from="${user.SecAppUser.list()}" optionKey="id" required="" value="${secAppUserSecAppRoleInstance?.secAppUser?.id}" class="many-to-one"/>
</div>
