...
<html>
    ...
    <body>
        <ul class="breadcrumbs">
            ...
            <li>Mostrar Control de Sesiones</li>
        </ul>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <div class="widget">
                    <h4 class="widgettitle" style="font-size: 30px;">Control de Sesiones: ${sesionControlInstance?.id}</h4>
                        ...
                        <div id="show-sesionControl" class="content scaffold-show" role="main">
                            ...
                            <g:form>
                                <fieldset class="buttons">
                                    ...
                                    <g:link class="btn btn-primary" action="edit" id="${sesionControlInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
