...
<html>
	...
	<body>
		<a href="#show-medicHistory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-medicHistory" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${medicHistoryInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
